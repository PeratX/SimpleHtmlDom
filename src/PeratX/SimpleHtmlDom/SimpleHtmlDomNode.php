...
class SimpleHtmlDomNode{
	...
	function text(){
		...
		switch($this->nodeType){
			case SimpleHtmlDom::HDOM_TYPE_TEXT:
				return $this->dom->restoreNoise($this->_[SimpleHtmlDom::HDOM_INFO_TEXT]);
			case SimpleHtmlDom::HDOM_TYPE_COMMENT:
				return '';
			case SimpleHtmlDom::HDOM_TYPE_UNKNOWN:
				return '';
		}
		...
		foreach($this->attr as $key => $val){
			...
			if($val === true)
				...
				switch($this->_[SimpleHtmlDom::HDOM_INFO_QUOTE][$i]){
					case SimpleHtmlDom::HDOM_QUOTE_DOUBLE:
						$quote = '"';
						break;
					case SimpleHtmlDom::HDOM_QUOTE_SINGLE:
						$quote = '\'';
						break;
					default:
						$quote = '';
	...
	public function __set($name, $value){
		switch($name){
			case 'outerText':
				return $this->_[SimpleHtmlDom::HDOM_INFO_OUTER] = $value;
			case 'innerText':
